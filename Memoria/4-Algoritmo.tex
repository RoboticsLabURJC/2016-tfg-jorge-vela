...
despegue, b\'usqueda y aterrizaje. La figura \ref{fig:Esquema_control2} indica el esquema de control que sigue el algoritmo
...
\begin{figure}[H]
 \centering
  \subfloat[Precise Landing]{
   \label{f:pl1}
    \includegraphics[width=0.44\textwidth]{imgs/PreciseLanding1.png}}
  \subfloat[Diagrama de Estados]{
   \label{f:pl2}
    \includegraphics[width=0.40\textwidth]{imgs/PreciseLanding2.png}} 
